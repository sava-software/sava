...
/// @param updateAuthority may update the group; [PublicKey#NONE] when absent, never `null`.
/// @param size            the current member count, unsigned.
/// @param maxSize         the member limit, unsigned.
