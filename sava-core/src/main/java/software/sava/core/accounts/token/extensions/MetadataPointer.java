...
/// @param authority       may update the pointer; [PublicKey#NONE] when absent, never `null`.
/// @param metadataAddress the account holding the metadata; [PublicKey#NONE] when absent,
///                        never `null`.
